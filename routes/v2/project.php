...
Route::middleware('auth:sanctum')->name('api.')->group( function () {
    ...
    Route::post('projects/{id}/add-team', 'Api\v2\Project\ProjectController@addTeam')->name('projects.addTeam');
    Route::post('projects/{id}/remove-team', 'Api\v2\Project\ProjectController@addTeam')->name('projects.removeTeam');
